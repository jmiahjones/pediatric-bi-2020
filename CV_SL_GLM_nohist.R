...
sens_data_path <- "./sensitivity_analysis_data.csv"
# output files
bootstrap_file <- "./results/SL_bootstrap_nohist.RData"
false_neg_pred_file <- "./results/sens_pred_false_negative_point01.csv"
auc_diff_file <- "./results/sens_auc_diff.txt"
report_table_file <- "./results/sens_report_table.csv"
lr_table_file <- "./results/sens_lr_table.csv"
superiority_file <- "./results/sens_superiority_table.csv"
auc_plot_file <- "./results/sens_auc.png"
...
features_nosocial = features.raw %>% select(Record.ID, sex, insurance, cm_condition, age,
                                            maxtemp, puti,
                                            BI)
